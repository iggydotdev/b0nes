...
/**
 * testComponent component - An element
 * 
 ...
 * @param {string | Object<string, string|boolean|number>} [props.attrs=''] - Additional HTML attributes as string or object (e.g., { id: 'main', disabled: true })
...
export const testComponent = ({attrs, className, slot}) => {
     // Validate required props
    validateProps(
        { slot },
        ['slot'],
        { testComponent: 'testComponent', atom: 'atom' }
    );
    ...
    validatePropTypes(
        ...
        { testComponent: 'button', atom: 'atom' }
    );
    ...
    return `<div class="${classes}"${attrsStr}>${slotContent}</div>`;
}